    ...
    return (
        <div>
            ...
            <div style={{
                ...
                <header style={{
                    ...
                    <div className="header-btns-menu">
                        ...
                        <button onClick={() => window.location.href = "/notfound"}>Location</button>
                        <button onClick={() => window.location.href = "/notfound"}>Type</button>
                        <button onClick={() => window.location.href = "/notfound"}>Price Range</button>
            ...
            <footer>
                ...
                <button onClick={() => window.location.href = "/notfound"}>Read more</button>
            </footer>
